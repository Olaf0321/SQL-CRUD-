...
from api_routes import items, tables, columns, child, list_column, fkcolumnName
...
app.include_router(fkcolumnName.router, prefix="/fkcolumnName", tags=["fkcolumnName"])
